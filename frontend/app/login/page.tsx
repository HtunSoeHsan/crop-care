...
import { Eye, EyeOff, Mail, Lock, Loader2, AlertCircle, User, Phone, Building } from 'lucide-react';
        ...
        <Card className="backdrop-blur-sm bg-white/80 border-0 shadow-2xl">
          <CardHeader className="text-center pb-6">
            ...
            <p className="text-gray-600 mt-2">
              {isLogin ? 'Sign in to your account to continue' : 'Join us and get started today'}
            </p>
          </CardHeader>
